...
def main():
    filename_left_image = "./images/panoramaStitching/1.1.jpg"
    filename_right_image = "./images/panoramaStitching/1.2.jpg"

    output_path_left = change.convert_image_to_png(filename_left_image,"./panoramaStitching")
    output_path_right = change.convert_image_to_png(filename_right_image,"./panoramaStitching")
